            ...
            R.id.btn_save -> {
                ...
                when {
                    ...
                    saveImageToInternalStorage == null -> {
                        ...
                        val sharedPref = getSharedPreferences("HappyPlacesPrefs", MODE_PRIVATE)
                        val loggedInEmail = sharedPref.getString("loggedInUser", "") ?: ""

                        if (mHappyPlaceDetails == null) {
                            val addHappyPlace = dbHandler.addHappyPlace(happyPlaceModel, loggedInEmail)

                            if (addHappyPlace > 0) {
                                setResult(Activity.RESULT_OK)
                                finish()
                            } else {
                                Log.e("AddHappyPlace", "Failed to add Happy Place")
                            }
                        } else {
                            ...
                            if (updateHappyPlace > 0) {
                                ...
                                Log.e("AddHappyPlace", "Failed to update Happy Place")
                            }
                        }
